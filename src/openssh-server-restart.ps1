...
# Check if the OpenSSH server is running; restart it if so.

if ($service.Status -ne 'Running') {

    # Notify user.

    Write-Host "The OpenSSH server is not running. Please start it first.";
    ...
    Write-Host "The OpenSSH server is running. Restarting now...";
    ...
    Write-Host "The OpenSSH server has been restarted.";
