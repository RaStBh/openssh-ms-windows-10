...
# Check if ssh-agent is running; stop it if so.

if ($service.Status -ne 'Running') {

    # Notify user.

    Write-Host "ssh-agent is already stopped.";
    ...
    Write-Host "ssh-agent is running. Stopping now...";
    ...
    Write-Host "ssh-agent is now stopped.";
}
