...
# Check if the OpenSSH server is running; start it if not.
...
if ($service.Status -eq 'Running') {
    ...
    Write-Host "The OpenSSH server is not running. Starting now...";
    ...
    Write-Host "The OpenSSH server is now running.";
