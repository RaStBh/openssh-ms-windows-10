...
# Check if the OpenSSH server is installed; uninstall it if so.

if ($capability.State -ne 'Installed') {
  
    # Notify user.
  
    Write-Host "The OpenSSH server is not installed.";
    ...
    Write-Host "The OpenSSH server is installed. Uninstalling now...";
    ...
    Write-Host "The OpenSSH server is now uninstalled.";
}
